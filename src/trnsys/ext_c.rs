...
extern "C" {
    ...
    pub fn INITREPORTMINMAX(
        index: *mut c_int,
        minmaxName: *mut c_char,
        minmaxUnit: *mut c_char,
        LenName: usize,
        LenUnit: usize,
    );
    pub fn INITREPORTTEXT(
        index: *mut c_int,
        txtName: *mut c_char,
        txtVal: *mut c_char,
        LenName: usize,
    ...
    pub fn SETNUMBEROFREPORTVARIABLES(
        nInt: *mut c_int,
        nMinMax: *mut c_int,
        nVals: *mut c_int,
        nText: *mut c_int,
    ...
    pub fn TRNSYSFUNCTIONS_mp_GETFORMAT(
        label: *mut c_char,
        llen: usize,
        iunit: *mut c_int,
        no: *mut c_int,
    ...
    pub fn TRNSYSFUNCTIONS_mp_GETLABEL(
        label: *mut c_char,
        llen: usize,
        iunit: *mut c_int,
        no: *mut c_int,
    ) -> *mut c_char;
    pub fn TRNSYSFUNCTIONS_mp_GETLUFILENAME(
        name: *mut c_char,
        llen: usize,
        lu: *mut c_int,
    ) -> *mut c_char;
    ...
    pub fn GETHORIZONTALRADIATION(
        Time: *mut c_double,
        mode_rad: *mut c_int,
        mode_shape: *mut c_int,
        rad_input: *mut c_double,
        rhog: *mut c_double,
        slope: *mut c_double,
        azimuth: *mut c_double,
        mode_track: *mut c_int,
        mode_tilt: *mut c_int,
        latitude: *mut c_double,
        alt: *mut c_double,
        shift: *mut c_double,
        i_solartime: *mut c_int,
        SolConst: *mut c_double,
        td1: *mut c_double,
        td2: *mut c_double,
        solar: *mut c_double,
        ierror_rad: *mut c_int,
    );
    pub fn GETTILTEDRADIATION(
        Time: *mut c_double,
        rhog: *mut c_double,
        slope: *mut c_double,
        azimuth: *mut c_double,
